 ...
 */
export async function checkAndIncrementQuota(extensionId) {
  try {
 ...
 */
export async function getUserByExtensionId(extensionId) {
  try {
 ...
 */
export async function createUser(extensionId, userInfo = {}) {
  try {
    const { data, error } = await supabase
      .from('users')
      .insert({
 ...
 */
export async function logUsage(userId, actionType, metadata = {}) {
  try {
    const { data, error } = await supabase
      .from('usage_logs')
      .insert({
 ...
 */
export async function createUserSubscription(userId, planId, subscriptionData) {
  try {
    const { data, error } = await supabase
 ...
 */
export async function updateSubscriptionStatus(stripeSubscriptionId, updateData) {
  try {
    const { data, error } = await supabase
      .from('user_subscriptions')
      .update({
 ...
 */
export async function recordPaymentTransaction(userId, transactionData) {
  try {
    const { data, error } = await supabase
